...
*/
    ...
    /**
     * Regresa el SessionFactory usado por esta clase est�tica.
     *
     * @return SessionFactory
     */
    ...
    /**
     * Reconstruye SessionFactory con la misma configuraci�n
     *
     */
    ...
    public static Session getSession()
        ...
        try {
            if (s == null) {
                if (log.isDebugEnabled()) {
                    log.debug("-Abriendo una nueva sesi�n para el thread.");
                }
    ...
    public static void closeSession()
        ...
        try {
            ...
            if (s != null && s.isOpen()) {
                if (log.isDebugEnabled()) {
                    log.debug("-Cerrando la sesi�n local al thread.");
                }
                s.close();
            }
        } catch (HibernateException ex) {
    ...
    /**
     * Inicia una nueva transacci�n de base de datos
     */
    public static void beginTransaction()
        ...
        try {
            if (tx == null) {
                if (log.isDebugEnabled()) {
                    log.debug("-Iniciando una nueva transacci�n de base de datos en este thread.");
                }
    ...
    /**
     * Compromete la transacci�n de base de datos.
     */
    public static void commitTransaction()
        ...
        try {
            if ( tx != null && !tx.wasCommitted()
                            && !tx.wasRolledBack() ) {
                if (log.isDebugEnabled()) {
                    log.debug("-Comprometiendo la transacci�n de este thread.");
                }
                tx.commit();
            }
            ...
            if (log.isDebugEnabled()) {
                log.debug("-Deshaciendo la transacci�n de este thread.");
            }
            rollbackTransaction();
            log.error("<HibernateException");
            throw new ExcepcionInfraestructura(ex);
    ...
    /**
     * Deshace la transacci�n de base de datos
     */
    public static void rollbackTransaction()
        ...
        try {
            ...
            if ( tx != null && !tx.wasCommitted() && !tx.wasRolledBack() ) {
                if (log.isDebugEnabled()) {
                    log.debug("-Intentando deshacer la transacci�n para este thread.");
                }
                tx.rollback();
            }
        } catch (HibernateException ex) {
            ...
            if (log.isDebugEnabled()) {
                log.debug("-Intentando cerrar la sesi�n.");
            }
            closeSession();
        }
    }
